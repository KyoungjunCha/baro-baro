...
//	private String CLIENT_PW;
	...
	public String getLoginFormURL(SocialType socialType, String state) {
		...
		System.out.println("KakaoOauth : "+ parameterString);
	...
	public Map<String, String> requestAccessToken(String code) {
	    ...
	    try {
	        ...
	        ResponseEntity<Map<String, String>> responseEntity = restTemplate.exchange(
	            ENDPOINT_URL_TOKEN,    // 카카오의 토큰 엔드포인트
	        ...
	        System.out.println("KakaoOauth.requestAccessToken() accessToken: " + this.ACCESS_TOKEN);

	        System.out.println("KakaoOauth : " + responseBody);
	...
	public UserInfo getUserInfo2(String accessToken) {
	    ...
	    ResponseEntity<Map<String, Object>> responseEntity = restTemplate.exchange(
	        ENDPOINT_URL_USERINFO, // 카카오 유저 정보 API 엔드포인트
	        HttpMethod.GET,
	        entity,
	    ...
	    System.out.println("카카오 유저 정보 응답: " + responseBody);
	    ...
	    Map<String, Object> response = (Map<String, Object>) responseBody.get("properties");
	    
	    // UserInfo 객체에 값을 매핑
//	    UserInfo userInfo = new UserInfo();
//	    userInfo.setProfile_nickname((String) ((Map<String, Object>) responseBody.get("properties")).get("nickname"));
//	    userInfo.setEmail((String) ((Map<String, Object>) responseBody.get("kakao_account")).get("email"));
//	    userInfo.setUserStatus(CommonCode.UserStatus.ACTIVE); // 기본값 설정 (상태 값은 적절하게 처리 필요)
//	    userInfo.setUserRole(CommonCode.Role.GENERAL); // 기본값 설정 (역할 값은 적절하게 처리 필요)

...
//				public void run() {
//					try {
//						String notificationJson = new ObjectMapper().writeValueAsString(finalNvo); // NotificationVO 객체를
//																									// JSON으로 직렬화
//						finalEmitter.send(SseEmitter.event().name("notification").data(notificationJson)); // 알림 데이터 전송
